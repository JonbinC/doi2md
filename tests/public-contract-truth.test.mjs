...
test("install manifest stays mirrored with the active site manifest and keeps CLI-first public truth", async () => {
  ...
  assert.equal(manifest.releaseTruth?.current?.cli?.globalInstallCommand, "npm install -g mdtero-install@0.1.8");
  assert.equal(manifest.releaseTruth?.latest?.cli?.globalInstallCommand, "npm install -g mdtero-install@0.1.8");
...
test("public install docs keep CLI + extension launch truth and desktop as deferred archive", async () => {
  ...
  expectContains(publicReadme, "npm install -g mdtero-install@0.1.8", "mdtero-public/README.md");
  ...
  expectContains(publicReadme, "installs the currently published public CLI package", "mdtero-public/README.md");
  ...
  expectContains(publicReadme, "exposes the current `mdtero` command", "mdtero-public/README.md");
  expectContains(publicReadme, "not implemented in the npm CLI yet", "mdtero-public/README.md");
  ...
  expectContains(publicReadme, "npx --yes mdtero-install install <target>", "mdtero-public/README.md");
  ...
  expectContains(publicReadme, "`npx mdtero-install install <target>` remains available", "mdtero-public/README.md");
  ...
  expectContains(installReadme, "never claim the unpublished uv/PyPI route is currently available", "mdtero-public/install/README.md");
  expectContains(installReadme, "never delete user papers or Markdown", "mdtero-public/install/README.md");
  expectContains(installReadme, "npm install -g mdtero-install@0.1.8", "mdtero-public/install/README.md");
  expectContains(installReadme, "npx --yes mdtero-install install <target>", "mdtero-public/install/README.md");
  ...
  expectContains(installReadme, "npm uninstall -g mdtero-install", "mdtero-public/install/README.md");
  expectContains(installReadme, "reviewable skill-bundle route", "mdtero-public/install/README.md");
  ...
  expectContains(installReadme, "does not remove the CLI package, API keys, generated Markdown, downloaded papers, or user project data", "mdtero-public/install/README.md");
  ...
  expectContains(installReadme, "installs the currently published public CLI package", "mdtero-public/install/README.md");
  ...
  expectContains(installReadme, "exposes the current `mdtero` command", "mdtero-public/install/README.md");
