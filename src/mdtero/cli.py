...
def _batch_item_summary(input_value: str, result: dict[str, Any], *, route_kind: Any = None) -> dict[str, Any]:
    ...
    return {
        ...
        "provider_id": task.get("provider_id") or _task_result(task).get("provider_id"),
        "top_connector": task.get("top_connector") or _task_result(task).get("top_connector"),
        "publisher_family": task.get("publisher_family") or _task_result(task).get("publisher_family"),
            ...
            output.append(
                {
                    ...
                    "top_connector": row.get("top_connector"),
...
def _manifest_row_from_batch_item(item: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "top_connector": item.get("top_connector"),
        "publisher_family": item.get("publisher_family"),
