...
const COPY = {
  en: {
    ...
    advanced: "Advanced",
    apiUrl: "API URL",
    elsevierSettingsTitle: "Authorized source access",
    elsevierSettingsNote: "Optionally add an access key issued to you by an authorized source.",
    elsevierConfigured: "Configured",
    elsevierNotConfigured: "Not configured",
    elsevierKeyVisible: "Hide",
    elsevierKeyHidden: "Show",
    elsevierKeySaved: "Access key saved in this browser.",
    elsevierKeyCleared: "Access key cleared.",
    clearElsevierKey: "Clear key",
    elsevierApiKey: "Access key",
    elsevierApiKeyPlaceholder: "Paste your access key",
    elsevierApiKeyNote: "Stored only in this browser and used only when you enable this access.",
    save: "Save settings",
  ...
  zh: {
    ...
    advanced: "高级设置",
    apiUrl: "API 地址",
    elsevierSettingsTitle: "授权来源访问",
    elsevierSettingsNote: "可选：添加由授权来源签发给你的访问密钥。",
    elsevierConfigured: "已配置",
    elsevierNotConfigured: "未配置",
    elsevierKeyVisible: "隐藏",
    elsevierKeyHidden: "显示",
    elsevierKeySaved: "访问密钥已保存在本浏览器。",
    elsevierKeyCleared: "访问密钥已清除。",
    clearElsevierKey: "清除 key",
    elsevierApiKey: "访问密钥",
    elsevierApiKeyPlaceholder: "粘贴你的访问密钥",
    elsevierApiKeyNote: "仅保存在当前浏览器，且只在你启用此访问方式时使用。",
    save: "保存设置",
    historyTitle: "账户历史",
...
const permissionsStorageEl = document.querySelector<HTMLParagraphElement>("#permissions-storage");
...
function updateConnectionPill(isSignedIn: boolean) {
  if (!connectionPillEl) {
    return;
  }
  const copy = copyFor(uiLanguage);
