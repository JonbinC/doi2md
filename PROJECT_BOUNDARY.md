...
It is being consolidated toward the `doi2md` GitHub repo while preserving the existing public extension history.
...
- historical MCP code may remain under `archive/`
- archived content is reference-only and is not an actively maintained surface
